...
export function DeleteBookingButton({ id, locationId }: { id: number; locationId: number }) {
  const [open, setOpen] = useState(false);
  const [pending, startTransition] = useTransition();

  function handleConfirm() {
    startTransition(async () => {
      await deleteBooking(id, locationId);
      setOpen(false);
    });
  }
  ...
  return (
    <>
      ...
      <DeleteConfirmModal
        ...
        description="This will permanently delete the booking. This cannot be undone."
